  ...
  return (
        ...
        <div className='hidden sm:block pt-36'>
          <div className='flex max-h-[85vh]'>
            ...
            <div className='w-4/12 bg-white pb-10'>
              {/* Wrapper */}
              <div className='pt-8 md:pt-10 lg:pt-20'>
                {/* Header Of Form */}
                <div>
                  <h1 className='font-DanaMedium md:font-DanaDemiBold md:text-lg lg:text-2xl text-center pb-2 md:pb-4 tracking-tight md:tracking-normal'>ارتـباط بـا مـا</h1>
                    <p className='lg:font-DanaMedium text-center tracking-tighter lg:tracking-normal'>نظر یا انتقادتو بنویس برامون :)</p>
                </div>
                ...
                <div className='mt-8 lg:mt-16 mr-6 lg:mr-16 ml-8 lg:ml-12 text-start'>
                  ...
                  <div>
                    ...
                    <div>
                      <h1>آدرس ایمیل</h1>
                      <input type='password' placeholder='آدرس ایمیل خود را وارد نمایید...' />
                    </div>
                    <div>
                    <h1>شماره تماس</h1>
                    ...
                    <div>
                      <h1>متن</h1>
                    <textarea className='w-full h-20 px-1.5 py-2 text-[10px] md:text-xs lg:text-sm tracking-tighter border border-teal-600 focus:outline-none focus:border-2 rounded-sm' placeholder='متن خود خود را وارد نمایید...' />
                  </div>
                    <button type='submit' className='w-full h-8 md:h-10 lg:h-14 font-DanaMedium text-xs md:text-sm lg:text-base bg-teal-700 text-white rounded-md md:rounded-lg hover:bg-teal-600 transition-all'>ارسال</button>
                  </form>
                </div>
              </div>
            </div>
          ...
          <div>
            ...
            <div className='bg-white pb-10'>
              ...
              <div className='pt-8 px-8'>
                {/* Header Of Form */}
                <div>
                  <h1 className='font-DanaDemiBold text-lg text-center pb-2'>ارتـباط بـا مـا</h1>
                    <p className='text-center tracking-tight'>نظر یا انتقادتو بنویس برامون :)</p>
                </div>
                {/* Register Form Section */}
                <div className='mt-8 lg:mt-16 mr-6 lg:mr-16 ml-8 lg:ml-12 text-start'>
                  <form>
                  <div>
                    ...
                    <div>
                      <h1>متن</h1>
                    <textarea className='w-full h-20 px-1.5 py-2 text-[10px] tracking-tighter border border-teal-600 focus:outline-none focus:border-2 rounded-sm' placeholder='متن خود خود را وارد نمایید...' />
                  </div>
                    <button type='submit' className='w-full h-10 lg:h-14  font-DanaMedium text-sm lg:text-base bg-teal-700 text-white rounded-lg hover:bg-teal-600 transition-all'>ارسال</button>
                  </form>
                </div>
              </div>
            </div>
