            ...
            <div className='flex gap-x-5 py-8 px-5 lg:px-7 border border-gray-300 rounded-b-xl xl:rounded-xl'>
              ...
              <div>
                ...
                <div className='mt-5 pb-4 border-b border-gray-300'>
                  <p className='flex gap-1 pb-4'>
                    <span className='text-zinc-600 dark:text-white/90'>رنگ:</span>
              ...
              <div>
                ...
                <div className='w-full overflow-hidden'>
                  ...
                  >
                    <SwiperSlide>
                      <img className='h-72 lg:h-80 2xl:h-96 scale-125 lg:scale-100 cursor-pointer' src='/images/products/airpods.png' onClick={event => openImagesModal(event.target.src)} />
                    </SwiperSlide>
                    <SwiperSlide>
                      <img className='h-72 lg:h-80 2xl:h-96 scale-125 lg:scale-100 cursor-pointer' src='/images/products/airpods3.png' onClick={event => openImagesModal(event.target.src)} />
                    </SwiperSlide>
                    <SwiperSlide>
                      <img className='h-72 lg:h-80 2xl:h-96 scale-125 lg:scale-100 cursor-pointer' src='/images/products/airpod2.png' onClick={event => openImagesModal(event.target.src)} />
                    </SwiperSlide>
                    <SwiperSlide>
                      <img className='h-72 lg:h-80 2xl:h-96 scale-125 lg:scale-100 cursor-pointer' src='/images/products/airpods4.png' onClick={event => openImagesModal(event.target.src)} />
                    </SwiperSlide>
                  </Swiper>
                  <Swiper
                  ...
                  >
                    ...
                    <SwiperSlide>
                      <img className='product__album-img' src='/images/products/airpods3.png' />
                    </SwiperSlide>
                    <SwiperSlide>
                      <img className='product__album-img' src='/images/products/airpod2.png' />
                    </SwiperSlide>
                    <SwiperSlide>
                      <img className='product__album-img' src='/images/products/airpods4.png' />
                    </SwiperSlide>
                  </Swiper>
                  ...
                  {isModalOpen && (
                    <div
                      ...
                      <button
                          onClick={closeModal}
                          className="absolute top-32 right-56 flex-center gap-x-1 text-white bg-purple-500 rounded-full px-4 py-2"
                        >
                          <FaXmark/>
                          بستن
                        </button>
