          ...
          <div className='pt-8 md:pt-10 lg:pt-20'>
            ...
            <div className='mt-8 lg:mt-16 mr-6 lg:mr-16 ml-8 lg:ml-12 text-start'>
              <form>
                ...
                <button type='submit' className='w-full h-8 md:h-10 lg:h-14 mt-1.5 md:mt-3 lg:mt-5 font-DanaMedium text-xs md:text-sm lg:text-base bg-teal-700 text-white rounded-md md:rounded-lg hover:bg-teal-600 transition-all'>ورود</button>
              </form>
            </div>
          </div>
        </div>
          ...
          <div className='pt-8 px-8'>
            ...
            <div className='mt-8 lg:mt-16 mr-6 lg:mr-16 ml-8 lg:ml-12 text-start'>
              <form>
                ...
                <button type='submit' className='w-full h-10 lg:h-14 mt-3 lg:mt-5 font-DanaMedium text-sm lg:text-base bg-teal-700 text-white rounded-lg hover:bg-teal-600 transition-all'>ورود</button>
              </form>
            </div>
          </div>
        </div>
