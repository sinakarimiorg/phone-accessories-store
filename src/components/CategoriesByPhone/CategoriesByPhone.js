        ...
        <div>
            <div className='container'>
                ...
                <div className='grid grid-cols-2 lg:grid-cols-4 gap-6 w-full overflow-hidden child:cursor-pointer child:rounded-2xl'>
                    <img className='2xl:w-[355px] 2xl:h-72' src='images/categoriesByPhone/apple.jpg'/>
                    <img className='2xl:w-[355px] 2xl:h-72' src='images/categoriesByPhone/samsung.jpg'/>
                    <img className='2xl:w-[355px] 2xl:h-72' src='images/categoriesByPhone/xiaomi.jpg'/>
                    <img className='2xl:w-[355px] 2xl:h-72' src='images/categoriesByPhone/huawei.jpg'/>
                </div>
            </div>
        </div>
    )
