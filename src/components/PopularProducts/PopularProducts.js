        ...
        <div>
            <div className='container'>
                ...
                <div className='overflow-hidden section-border bg-gradient-to-r from-rose-50 to-indigo-100 py-4 px-2.5 md:py-8'>
                    ...
                    >
                        <SwiperSlide>
                            <ProductBox img={'/images/products/airpods.png'} img2={'/images/products/airpod2.png'} title={'هندزفری بلوتوثی کربی مدل CR-T107'} classes={'product-box'} price={765000} discount={10} exPrice={850000} />
                        </SwiperSlide>
                        ...
                        <SwiperSlide>
                            <ProductBox img={'/images/products/power-bank3.png'} img2={'/images/products/power-bank4.png'} title={'هندزفری بلوتوثی کربی مدل CR-T107'} classes={'product-box'} price={765000} />
                        </SwiperSlide>
                        <SwiperSlide>
                        ...
                        <SwiperSlide>
                            <ProductBox img={'/images/products/airpods.png'} title={'هندزفری بلوتوثی کربی مدل CR-T107'} classes={'product-box'} price={765000} discount={88} exPrice={970000} />
                        </SwiperSlide>

                        <SwiperSlide>
                            <ProductBox img={'/images/products/charge-cable.png'} title={'هندزفری بلوتوثی کربی مدل CR-T107'} classes={'product-box'} price={765000} discount={10} exPrice={850000} />
                        </SwiperSlide>
                    </Swiper>
